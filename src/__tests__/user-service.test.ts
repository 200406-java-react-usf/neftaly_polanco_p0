...
describe('userService', () => {
    ...
    let mockUsers = [
        new User(1, 'aanderson', 'password', 'Alice', 'Anderson', 'aanderson@revature.com', '(257) 273-4561', 'Admin'),
        new User(2, 'bbailey', 'password', 'Bob', 'Bailey', 'bbailey@revature.com', '(257) 273-4562', 'Staff'),
        new User(3, 'ccountryman', 'password', 'Charlie', 'Countryman', '(257) 273-4563', 'ccountryman@revature.com', 'Staff'),
        new User(4, 'ddavis', 'password', 'Daniel', 'Davis', 'ddavis@revature.com', '(257) 273-4564', 'Customer'),
        new User(5, 'eeinstein', 'password', 'Emily', 'Einstein', 'eeinstein@revature.com', '(257) 273-4565', 'Customer')
    ];
