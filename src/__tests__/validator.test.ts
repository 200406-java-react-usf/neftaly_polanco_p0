...
describe('validator', () => {
    ...
    test('should return true when isValidObject is provided valid object with no nullable props', () => {
        ...
        // Act
        let result1 = isValidObject(new Book(1, 'title', 50));
        let result2 = isValidObject(new User(1, 'username', 'password', 'first', 'last', 'phone','email', 'role'));
        let result3 = isValidObject(new Transaction(1, 'username', 50, new Date()));
        // Assert
        expect(result1).toBe(true);
        expect(result2).toBe(true);
        expect(result3).toBe(true);
    ...
    test('should return false when isValidObject is provided invalid object with no nullable prop(s)', () => {
        ...
        // Act
        let result1 = isValidObject(new Book(1, '', 50));
        let result2 = isValidObject(new User(1, 'username', 'password', '', 'last', 'email', 'phone', 'role'));
        let result3 = isValidObject(new Transaction(1, '', 50, new Date()));
    ...
    test('should return false when isValidObject is provided invalid object with some nullable prop(s)', () => {
        ...
        // Act
        let result1 = isValidObject(new Book(1, '', 50), 'id');
        let result2 = isValidObject(new User(1, 'username', 'password', '', 'last', 'email', 'phone', 'role'), 'id');
        let result3 = isValidObject(new Transaction(1, '', 50, new Date()), 'id');
    ...
    test('should return true when isPropertyOf is provided a known property of a given constructable type', () => {
        ...
        let result3 = isPropertyOf('title', Book);
        let result4 = isPropertyOf('total', Transaction)
        let result5 = isPropertyOf('date', Transaction);
    ...
    test('should return false when isPropertyOf is provided a unknown property of a given constructable type', () => {
        ...
        let result3 = isPropertyOf('titl', Book);
        let result4 = isPropertyOf('joke', Book);
        let result5 = isPropertyOf('youKidding', Transaction);
